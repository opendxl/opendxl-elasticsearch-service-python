...
Use ``pip`` to automatically install the library:
    ...
    .. parsed-literal::
        ...
        pip install dxldomaintoolsservice-\ |version|\-py2.py3-none-any.whl

Or with:

    .. parsed-literal::

        pip install dxldomaintoolsservice-\ |version|\.zip

As an alternative (without PIP), unpack the dxldomaintoolsservice-\ |version|\.zip (located in the lib folder) and run the setup
script:
