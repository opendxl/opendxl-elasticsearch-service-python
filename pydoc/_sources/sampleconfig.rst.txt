...
configuration file (``dxlclient.config``) located in the ``sample``
...
in the `OpenDXL Python SDK`, see the
...
(``dxlelasticsearchservice.config``) with settings specific to the APIs and
