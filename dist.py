...
VERSION = __import__('dxlelasticsearchservice').get_version()
RELEASE_NAME = "dxlelasticsearchservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlelasticsearchservice-python-dist-config-" + str(VERSION)
...
print("\nRemoving dxlelasticsearchservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlelasticsearchservice.egg-info"))
